...
func TestApplyClaudeHeaders_UsesConfiguredBaselineFingerprint(t *testing.T) {
	...
	applyClaudeHeaders(req, auth, "key-baseline", false, nil, cfg, helps.DefaultClaudeDeviceProfilePublic(cfg))
...
func TestApplyClaudeHeaders_TracksHighestClaudeCLIFingerprint(t *testing.T) {
	...
	applyClaudeHeaders(firstReq, auth, "key-upgrade", false, nil, cfg, helps.DefaultClaudeDeviceProfilePublic(cfg))
	...
	applyClaudeHeaders(thirdPartyReq, auth, "key-upgrade", false, nil, cfg, helps.DefaultClaudeDeviceProfilePublic(cfg))
	...
	applyClaudeHeaders(higherReq, auth, "key-upgrade", false, nil, cfg, helps.DefaultClaudeDeviceProfilePublic(cfg))
	...
	applyClaudeHeaders(lowerReq, auth, "key-upgrade", false, nil, cfg, helps.DefaultClaudeDeviceProfilePublic(cfg))
...
func TestApplyClaudeHeaders_DoesNotDowngradeConfiguredBaselineOnFirstClaudeClient(t *testing.T) {
	...
	applyClaudeHeaders(olderClaudeReq, auth, "key-baseline-floor", false, nil, cfg, helps.DefaultClaudeDeviceProfilePublic(cfg))
	...
	applyClaudeHeaders(newerClaudeReq, auth, "key-baseline-floor", false, nil, cfg, helps.DefaultClaudeDeviceProfilePublic(cfg))
...
func TestApplyClaudeHeaders_UpgradesCachedSoftwareFingerprintWhenBaselineAdvances(t *testing.T) {
	...
	applyClaudeHeaders(officialReq, auth, "key-baseline-reload", false, nil, oldCfg, helps.DefaultClaudeDeviceProfilePublic(oldCfg))
	...
	applyClaudeHeaders(thirdPartyReq, auth, "key-baseline-reload", false, nil, newCfg, helps.DefaultClaudeDeviceProfilePublic(newCfg))
...
func TestApplyClaudeHeaders_LearnsOfficialFingerprintAfterCustomBaselineFallback(t *testing.T) {
	...
	applyClaudeHeaders(thirdPartyReq, auth, "key-custom-baseline-learning", false, nil, cfg, helps.DefaultClaudeDeviceProfilePublic(cfg))
	...
	applyClaudeHeaders(officialReq, auth, "key-custom-baseline-learning", false, nil, cfg, helps.DefaultClaudeDeviceProfilePublic(cfg))
	...
	applyClaudeHeaders(postLearningThirdPartyReq, auth, "key-custom-baseline-learning", false, nil, cfg, helps.DefaultClaudeDeviceProfilePublic(cfg))
...
func TestApplyClaudeHeaders_ThirdPartyBaselineThenOfficialUpgradeKeepsPinnedPlatform(t *testing.T) {
	...
	applyClaudeHeaders(thirdPartyReq, auth, "key-third-party-then-official", false, nil, cfg, helps.DefaultClaudeDeviceProfilePublic(cfg))
	...
	applyClaudeHeaders(officialReq, auth, "key-third-party-then-official", false, nil, cfg, helps.DefaultClaudeDeviceProfilePublic(cfg))
	assertClaudeFingerprint(t, officialReq.Header, "claude-cli/2.1.77 (external, cli)", "0.87.0", "v24.8.0", "MacOS", "arm64")
}
...
func TestApplyClaudeHeaders_DisableDeviceProfileStabilization(t *testing.T) {
	...
	applyClaudeHeaders(firstReq, auth, "key-disable-stability", false, nil, cfg, helps.DefaultClaudeDeviceProfilePublic(cfg))
	...
	applyClaudeHeaders(thirdPartyReq, auth, "key-disable-stability", false, nil, cfg, helps.DefaultClaudeDeviceProfilePublic(cfg))
	...
	applyClaudeHeaders(lowerReq, auth, "key-disable-stability", false, nil, cfg, helps.DefaultClaudeDeviceProfilePublic(cfg))
...
func TestApplyClaudeHeaders_LegacyModePreservesConfiguredUserAgentOverrideForClaudeClients(t *testing.T) {
	...
	applyClaudeHeaders(req, auth, "key-legacy-ua-override", false, nil, cfg, helps.DefaultClaudeDeviceProfilePublic(cfg))
...
func TestApplyClaudeHeaders_LegacyModeFallsBackToRuntimeOSArchWhenMissing(t *testing.T) {
	...
	applyClaudeHeaders(req, auth, "key-legacy-runtime-os-arch", false, nil, cfg, helps.DefaultClaudeDeviceProfilePublic(cfg))
...
func TestApplyClaudeHeaders_UnsetStabilizationAlsoUsesLegacyRuntimeOSArchFallback(t *testing.T) {
	...
	applyClaudeHeaders(req, auth, "key-unset-runtime-os-arch", false, nil, cfg, helps.DefaultClaudeDeviceProfilePublic(cfg))
